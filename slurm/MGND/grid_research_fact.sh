...
#SBATCH --output=results/MGND_grid_search_relation%j.txt
#SBATCH --error=errors/MGND_grid_search_relation%j.txt
#SBATCH --mem=8G
#SBATCH --time=4:00:00
#SBATCH --job-name=MGND_grid_search_relation
...
mask_ratios=(0.2 0.3)
multi_layer_weights=(1 0.1 0.001)
without_two_stage=(True)
# multi_mae_wieths=()
# Create a directory to save results
save_dir="./checkpoint/MGND_fact/"
mkdir -p $save_dir
